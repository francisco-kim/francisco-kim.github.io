...
* Musical cryptograms
A musical cryptogram has been used by Westerns composers to transcribe a text into music and vice versa. Here are some of the cryptograms that I have written for fun! The pdf file (written in French) can be downloaded [[file:docs/assets/images/miscellaneous/cryptogrammes.pdf][here]]!

#+ATTR_HTML: :align right
[[file:~/Dropbox/musique/musescore/composition/fuga_1/fuga-I-webpage/content/index.org::*Sitemap][Back to the sitemap]]
